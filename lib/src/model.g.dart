...
OpenIdProviderMetadata _$OpenIdProviderMetadataFromJson(Map json) =>
    new OpenIdProviderMetadata(
        ...
        (json['userinfo_encryption_enc_values_supported'] as List)?.map((
            v0) => v0 as String)?.toList(),
        requestObjectSigningAlgValuesSupported: (json['request_object_signing_alg_values_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        requestObjectEncryptionAlgValuesSupported: (json['request_object_encryption_alg_values_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        requestObjectEncryptionEncValuesSupported: (json['request_object_encryption_enc_values_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        tokenEndpointAuthMethodsSupported: (json['token_endpoint_auth_methods_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        tokenEndpointAuthSigningAlgValuesSupported: (json['token_endpoint_auth_signing_alg_values_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        displayValuesSupported: (json['display_values_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        claimTypesSupported: (json['claim_types_supported'] as List)?.map((
            v0) => v0 as String)?.toList(),
        claimsSupported: (json['claims_supported'] as List)?.map((
            v0) => v0 as String)?.toList(),
        serviceDocumentation: json['service_documentation'] == null ? null : Uri
            .parse(json['service_documentation']),
        claimsLocalesSupported: (json['claims_locales_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        uiLocalesSupported: (json['ui_locales_supported'] as List)?.map((
            v0) => v0 as String)?.toList(),
        ...
        opPolicyUri: json['op_policy_uri'] == null ? null : Uri.parse(
            json['op_policy_uri']),
        opTosUri: json['op_tos_uri'] == null ? null : Uri.parse(
            json['op_tos_uri']),
        checkSessionIframe: json['check_session_iframe'] == null ? null : Uri
            .parse(json['check_session_iframe']),
        endSessionEndpoint: json['end_session_endpoint'] == null ? null : Uri
            .parse(json['end_session_endpoint']),
        revocationEndpoint: json['revocation_endpoint'] == null ? null : Uri
            .parse(json['revocation_endpoint']),
        revocationEndpointAuthMethodsSupported: (json['revocation_endpoint_auth_methods_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        revocationEndpointAuthSigningAlgValuesSupported: (json['revocation_endpoint_auth_signing_alg_values_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        introspectionEndpoint: json['introspection_endpoint'] == null
            ? null
            : Uri.parse(json['introspection_endpoint']),
        introspectionEndpointAuthMethodsSupported: (json['introspection_endpoint_auth_methods_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        introspectionEndpointAuthSigningAlgValuesSupported: (json['introspection_endpoint_auth_signing_alg_values_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        codeChallengeMethodsSupported: (json['code_challenge_methods_supported'] as List)
            ?.map((v0) => v0 as String)
            ?.toList());
...
JsonWebKey _$JsonWebKeyFromJson(Map json) =>
    new JsonWebKey(
...
TokenResponse _$TokenResponseFromJson(Map json) =>
    new TokenResponse(
...
OpenIdJwtClaimSet _$OpenIdJwtClaimSetFromJson(Map json) =>
    new OpenIdJwtClaimSet(
        subject: json['sub'] as String,
        name: json['name'] as String,
        givenName: json['given_name'] as String,
        familyName: json['family_name'] as String,
        ...
        audience: ((json['aud'] is List ? json['aud'] : json['aud'] == null
            ? []
            : [json['aud']]) as List)
            ?.map((v0) => v0 as String)
            ?.toList(),
        ...
        authTime: json['auth_time'] == null
            ? null
            : json['auth_time'] is num
            ? new DateTime.fromMillisecondsSinceEpoch(
            (json['auth_time'] * 1000).toInt())
            : DateTime.parse(json['auth_time']),
        nonce: json['nonce'] as String,
        authenticationContextClassReference: json['acr'] as String,
        authenticationMethodsReferences: (json['amr'] as List)?.map((
            v0) => v0 as String)?.toList(),
